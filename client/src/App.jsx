          ...
          <div className="grid grid-cols-1 gap-x-8 gap-y-2 sm:grid-cols-2">
            ...
            <div>
              ...
              <select
                ...
                <option >هدم/ترميم/بناء ( بدون ترخيص )</option>
                <option >كلاب ضالة / مفترسة</option>
                <option >موقف عشوائي / زياده اجره</option>
                <option >انهيار عقار / جزء</option>                
                <option >إنارة / كهرباء</option>
                <option >باعة جائلين / إشغال طريق</option>
                <option >صرف صحي/تراكم مياه امطار /شنيشه/مطبق/مسدود</option>
          ...
          <div className="mt-3">
            <div>
              ...
              <TERipple rippleColor="white">
                <button
                  type="button"
                  className="inline-block mx-8 mb-4 rounded bg-primary px-16 pb-4 pt-2.5 text-xm font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)]"
